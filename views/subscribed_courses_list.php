...
$subscribe_courses = $student_obj->getSubscribedCourses($page);
$pagination = ceil($student_obj->getTotal('subscribe_course') / Student::$perPage);
?>
<!doctype html>
<html lang="en">
<head>
        ...
        <div class="container md-6" style="margin: auto;width: 50%;padding: 10px;">
            <table class="table">
                ...
                <?php while ($subscribe_course = $subscribe_courses->fetch_array()){ ?>
                    <tr>
                        <td><?php $subscribe_course['full_name'] ?></td>
                        <td><?php $subscribe_course['course_name'] ?></td>
                        <td><?php $subscribe_course['course_name'] ?></td>
                    </tr>
                <?php } ?>
                </tbody>
